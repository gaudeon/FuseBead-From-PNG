...
$hash->{'filename'} = $args{'filename'};
    ...
    # Bead depth and height defaults
    $hash->{'bead_depth'} = 1;
...
=head2 new
 ...
 Argument  :
    ...
    bead_depth - Optional. The depth of all generated beads. Defaults to 1.
        e.g. bead_depth => 2 # final depth of all beads are 2. So 2 x length x height

    bead_height - Optional. The height of all generated beads. Defaults to 1.
        e.g. bead_height => 2 # final height of all beads are 2. So depth x length x 2
